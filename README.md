...
|-----------|----------------------------------------|---------------------------------------|--------------------------------------------|
| `⟨φ\|`    | <span style="color:#FF6B6B">**Decision Operator**</span> (Bra) | Measurement basis                    | Active decision protocol                   |
| `H`       | <span style="color:#4ECDC4">**EPL Hamiltonian**</span>         | Time evolution operator              | Core algorithm engine                      |
| `\|ψ⟩`    | <span style="color:#FFD166">**Data Distribution**</span> (Ket)        | Quantum probability distribution     | Mined knowledge representation             |
