...
Specifically, we establish a computational correspondence to nature's three adaptive mechanisms: (1) evolutionary computation simultaneously models both biological evolution (through population-based genetic optimization) and swarm intelligence behaviors (via emergent agent coordination mechanisms), thereby capturing two fundamental layers of biological adaptation. (2) statistical physics formally characterizes developmental self-organization via disorder-to-order transitions mathematically equivalent to physical phase transitions; and (3) machine learning explicitly emulates biological learning through neural network training grounded in synaptic plasticity principles. However, contemporary artificial intelligence has predominantly focused on anthropocentric intelligence paradigms (e.g., neural networks mimicking human cognition), while largely neglecting equally fundamental forms of natural intelligence: (1) evolutionary/swarm intelligence in biological systems, and (2) self-organizing intelligence in physical systems. We argue that AI development should transcend human-centric models to embrace these broader adaptive mechanisms.
